...
namespace DBCompareTool.FileReader
{
	...
	public class FloatUtil
	{
		...
		public static unsafe int FloatToRawIntBits(float f) => *((int*)&f);
		public static unsafe int UIntToRawIntBits(uint u) => *((int*)&u);
		public static unsafe float IntBitsToFloat(int i) => *((float*)&i);
		...
		public static bool IsLikelyFloat(int value, int minexp = -7, int maxexp = 6)
		{
			...
			// exponent range check, range is from the Alpha client
